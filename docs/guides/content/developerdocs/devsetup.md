...
Please have a read of the PhantomBot [Code Style](https://phantombot.tv/guides/#guide=content/developerdocs/codestyle), any code that does not apply to these rules will not get merged.
